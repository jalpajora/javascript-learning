...
},{}],"fdW7u":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "ff7b2f5c6cf7aa4c";
"use strict";
...
},{}],"cHA1H":[function(require,module,exports) {
var _rxjs = require("rxjs");
// debounceTime -> delay
// debounce -> delayWhen
var foo = _rxjs.interval(100).pipe(_rxjs.take(5));
var result = foo.pipe(_rxjs.debounce(()=>_rxjs.interval(1000).pipe(_rxjs.take(1))
));
result.subscribe({
    next (x) {
        console.log(x);
...
},{"tslib":"j55WF","../observable/zip":"97KMy","../util/lift":"acAIF","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["emU3S","fdW7u","cHA1H"], "cHA1H", "parcelRequire619b")

//# sourceMappingURL=index.6cf7aa4c.js.map
