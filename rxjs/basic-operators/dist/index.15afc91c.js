...
},{}],"jCV8A":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "49d8446f15afc91c";
"use strict";
...
},{}],"iFvPR":[function(require,module,exports) {
var _rxjs = require("rxjs");
// combined = AND
var foo = _rxjs.interval(500).pipe(_rxjs.take(4));
var bar = _rxjs.interval(300).pipe(_rxjs.take(5));
var combined = foo.pipe(_rxjs.combineLatestWith(bar, (x, y)=>x + y
));
combined.subscribe({
    next (x) {
        console.log(x);
...
},{"tslib":"j55WF","../observable/zip":"97KMy","../util/lift":"acAIF","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["emU3S","jCV8A","iFvPR"], "iFvPR", "parcelRequire619b")

//# sourceMappingURL=index.15afc91c.js.map
