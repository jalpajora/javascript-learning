...
},{}],"7OpiZ":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "24c21f13de992660";
"use strict";
...
},{}],"5tgF9":[function(require,module,exports) {
var _rxjs = require("rxjs");
var foo = _rxjs.interval(600).pipe(_rxjs.take(5));
// var result = foo.pipe(delay(2000));
// var futureDate = new Date(new Date().getTime() + 1000);
// var result = foo.pipe(delay(futureDate));
var result = foo.pipe(_rxjs.delayWhen((x)=>_rxjs.interval(x * x * 100).pipe(_rxjs.take(1))
));
result.subscribe({
    next (x) {
        console.log(x);
...
},{"tslib":"j55WF","../observable/zip":"97KMy","../util/lift":"acAIF","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["emU3S","7OpiZ","5tgF9"], "5tgF9", "parcelRequire619b")

//# sourceMappingURL=index.de992660.js.map
