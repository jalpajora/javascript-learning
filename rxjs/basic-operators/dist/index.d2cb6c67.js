...
},{}],"5hJXN":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "720cacbdd2cb6c67";
"use strict";
...
},{}],"cZZhw":[function(require,module,exports) {
var _rxjs = require("rxjs");
// predicate function takes an argument and returns true or false
var foo = _rxjs.interval(500).pipe(_rxjs.take(4), _rxjs.map((x)=>`foo: ${x}`
));
var bar = _rxjs.interval(300).pipe(_rxjs.take(5), _rxjs.map((x)=>`bar: ${x}`
));
var merged = _rxjs.merge(foo, bar);
merged.subscribe({
    next (x) {
        console.log(x);
    },
...
},{"tslib":"j55WF","../observable/zip":"97KMy","../util/lift":"acAIF","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["emU3S","5hJXN","cZZhw"], "cZZhw", "parcelRequire619b")

//# sourceMappingURL=index.d2cb6c67.js.map
