...
},{}],"5ytQe":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "d1d331101f4dd7dc";
"use strict";
...
},{}],"bZ5qh":[function(require,module,exports) {
var _rxjs = require("rxjs");
var foo = _rxjs.of('H', 'e', 'l', 'l', 'o');
var bar = _rxjs.interval(600).pipe(_rxjs.take(5));
var combined = _rxjs.zip(foo, bar, (x, y)=>x
).pipe(_rxjs.scan((acc, x)=>acc + x
, ''));
combined.subscribe({
    next (x) {
        console.log(x);
...
},{"tslib":"j55WF","../observable/zip":"97KMy","../util/lift":"acAIF","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["emU3S","5ytQe","bZ5qh"], "bZ5qh", "parcelRequire619b")

//# sourceMappingURL=index.1f4dd7dc.js.map
