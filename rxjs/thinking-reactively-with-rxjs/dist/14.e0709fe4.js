...
},{}],"8xUfT":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "0c51bacfe0709fe4";
"use strict";
...
},{}],"18hQN":[function(require,module,exports) {
...
*/ const anyKeyPress = _rxjs.fromEvent(document, 'keypress').pipe(_operators.map((event)=>event.key
), _operators.tap(console.log));
function keyPressed1(key) {
    return anyKeyPress.pipe(_operators.filter((pressedKey)=>pressedKey === key
    ));
}
function keyCombo1(keyCombo) {
    const combiInitiator = keyCombo[0];
    return keyPressed1(combiInitiator).pipe(_operators.exhaustMap(()=>{
        return anyKeyPress.pipe(_operators.takeUntil(_rxjs.timer(3000)), _operators.takeWhile((keyPressed, index)=>{
            console.log('keypressed');
            console.log(keyPressed);
            console.log(index);
            return keyCombo[index + 1] === keyPressed;
        }), _rxjs.skip(keyCombo.length - 2), _operators.take(1));
    }));
}
const comboTriggered = keyCombo1([
    'a',
    's',
    'a',
    'f'
]);
_rxjs.interval(1000).pipe(_operators.takeUntil(comboTriggered)).subscribe({
...
var EMPTY_SUBSCRIPTION = Subscription1.EMPTY;
function isSubscription(value) {
    return value instanceof Subscription1 || value && 'closed' in value && _isFunction.isFunction(value.remove) && _isFunction.isFunction(value.add) && _isFunction.isFunction(value.unsubscribe);
}
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "OperatorSubscriber", ()=>OperatorSubscriber1
);
var _tslib = require("tslib");
var _subscriber = require("../Subscriber");
...
function generate(initialStateOrOptions, condition, iterate, resultSelectorOrScheduler, scheduler) {
    ...
    var resultSelector;
    var initialState;
    if (arguments.length === 1) _a1 = initialStateOrOptions, initialState = _a1.initialState, condition = _a1.condition, iterate = _a1.iterate, _b = _a1.resultSelector, resultSelector = _b === void 0 ? _identity.identity : _b, scheduler = _a1.scheduler;
    else {
...
function raceInit(sources) {
    return function(subscriber) {
        ...
        for(var i1 = 0; subscriptions && !subscriber.closed && i1 < sources.length; i1++)_loop_1(i1);
    };
}
...
function bufferTime(bufferTimeSpan) {
    ...
    var scheduler = (_a1 = _args.popScheduler(otherArgs)) !== null && _a1 !== void 0 ? _a1 : _async.asyncScheduler;
...
},{"tslib":"j55WF","../util/argsOrArgArray":"25sle","./raceWith":"9M9x7","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["emU3S","8xUfT","18hQN"], "18hQN", "parcelRequire227f")

//# sourceMappingURL=14.e0709fe4.js.map
